...
const FilePreviewModal = ({ previewData, onClose, onConfirm }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 z-50 flex items-center justify-center p-4">
      <div className="bg-white p-6 rounded-2xl shadow-2xl w-full max-w-lg text-gray-800">
        <h2 className="text-2xl font-bold mb-4">
          {fileType === 'image' ? 'Confirmar envío de imagen' : 'Confirmar envío de archivo'}
        </h2>

        <div className="flex justify-center items-center my-6 bg-gray-50 rounded-lg p-4 min-h-[200px] border border-gray-200">
          {fileType === 'image' ? (
            <img
              src={url}
              alt={file.name}
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                <span className="inline-block px-3 py-1 bg-gray-200 rounded-full text-sm font-semibold text-gray-700">
        ...
        <div className="space-y-2 text-gray-700 bg-gray-50 rounded-lg p-4 border border-gray-200">
        ...
        <div className="mt-6 flex justify-end space-x-4">
          <button
            type="button"
            onClick={onClose}
            className="px-6 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg font-semibold transition-colors text-gray-700"
          >
            Cancelar
          </button>
          <button
            ...
            className="px-6 py-2 bg-blue-500 hover:bg-blue-600 rounded-lg font-semibold transition-colors text-white"
          >
            Enviar
          </button>
        </div>
